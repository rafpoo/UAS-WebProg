    ...
    <div class="container">
        ...
        <form action="<?php echo e(route('admin.ekstrakurikuler.update', $ekstrakurikuler->id)); ?>" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="nama" name="nama" value="<?php echo e($ekstrakurikuler->nama); ?>" >
            </div>

            <!-- Gambar -->
            <div class="mb-3">
                <label for="image" class="form-label">Gambar (kosongkan jika tidak ingin mengganti)(Ukuran Max 2MB)</label>
                <img src="<?php echo e(asset('storage/' . $ekstrakurikuler->image)); ?>" alt="Gambar Saat Ini" style="width: 150px; display: block; margin-bottom: 10px;">
...
<?php /**PATH C:\xampp\htdocs\uazzzz\UAS-WebProg\resources\views/admin/ekstrakurikuler/edit.blade.php ENDPATH**/ ?>