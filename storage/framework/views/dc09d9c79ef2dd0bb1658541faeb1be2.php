...
<head>
    ...
    <title>Admin - Program Pembelajaran - TK Islam Kinasih</title>
...
<?php endif; ?>
    ...
    <div class="container">
        ...
        <div class="row row-cols-1 row-cols-md-3 g-4" style="display: flex; justify-content: center; margin-top: 20px;">
            <a href="<?php echo e(route('admin.aktivitas.create')); ?>" class="btn btn-warning">
                        ...
                        <ul class="list-group">
                            <?php $__currentLoopData = $reguler; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $aktivitas): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li class="list-group-item d-flex justify-content-between align-items-center">
                                    <span><strong><?php echo e($aktivitas->urutan); ?></strong>   <?php echo e($aktivitas->nama_aktivitas); ?></span>
                                    <div class="d-flex gap-2">
                                        <!-- Tombol Edit -->
                                        <form action="<?php echo e(route('admin.aktivitas.edit', $aktivitas->id)); ?>" method="GET">
                                        ...
                                        <!-- Tombol Delete -->
                                        <form id="delete-<?php echo e($aktivitas->id); ?>" action="<?php echo e(route('admin.aktivitas.destroy', $aktivitas->id)); ?>" method="POST">
                                            <?php echo csrf_field(); ?>
                                            <?php echo method_field('DELETE'); ?>
                                            <button type="button" class="btn btn-danger btn-sm" onclick="confirmDelete(<?php echo e($aktivitas->id); ?>)">
        ...
        <div class="extracurricular mt-5">
            ...
            <div class="row row-cols-1 row-cols-md-3 g-4" style="display: flex; justify-content: center; margin-top: 20px;">
                <a href="<?php echo e(route('admin.ekstrakurikuler.create')); ?>" class="btn btn-warning">
                ...
                <?php $__currentLoopData = $ekstrakurikulers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ekstrakurikuler): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="extracurricular-item">
                        ...
                        <div class="d-flex justify-content-between">
                            <!-- Tombol Edit -->
                            <a href="<?php echo e(route('admin.ekstrakurikuler.edit', $ekstrakurikuler->id)); ?>" class="btn btn-warning btn-sm">
                                <i class="bi bi-pencil-square"></i> Edit
                            </a>
                        
                            <!-- Tombol Delete -->
                            <form id="delete-<?php echo e($ekstrakurikuler->id); ?>" action="<?php echo e(route('admin.ekstrakurikuler.destroy', $ekstrakurikuler->id)); ?>" method="POST">
                                <?php echo csrf_field(); ?>
                                <?php echo method_field('DELETE'); ?>
                                <button type="button" class="btn btn-danger btn-sm" onclick="confirmDelete(<?php echo e($ekstrakurikuler->id); ?>)">
                                    <i class="bi bi-trash3"></i> Delete
                                </button>
                            </form>
                        </div>
...
</html><?php /**PATH C:\xampp\htdocs\uazzzz\UAS-WebProg\resources\views/admin/aktivitas/aktivitas.blade.php ENDPATH**/ ?>