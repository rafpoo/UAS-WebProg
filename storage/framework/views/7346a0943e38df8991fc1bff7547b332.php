...
<head>
    ...
    <title>Tambah Ekstrakurikuler - Admin - TK Islam Kinasih</title>
...
<body>
    <div class="container">
        ...
        <form action="<?php echo e(route('admin.ekstrakurikuler.store')); ?>" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                <label for="image" class="form-label">Foto Ekstrakurikuler (Ukuran Max 2MB)</label>
...
<?php /**PATH C:\Users\ziyad\Downloads\finalproject\UAS-WebProg\resources\views/admin/ekstrakurikuler/create.blade.php ENDPATH**/ ?>