    ...
    <div class="container">
      <div class="form-container ">
        ...
        <div class="illustration w-100 h-100">
          <img src="{{ URL('images/illustration.jpg') }}" alt="Illustration 1" class="img-fluid mb-4 w-100 h-100">
          <img src="{{ URL('images/illustration2.jpg') }}" alt="Illustration 2" class="img-fluid mb-4 w-100 h-100">
          <img src="{{ URL('images/illustration3.jpg') }}" alt="Illustration 3" class="img-fluid mb-4 w-100 h-100">
        </div>
      </div>
